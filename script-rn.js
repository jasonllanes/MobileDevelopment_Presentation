...
function downloadNodeJS() {
    ...
    showNotification('Opening Node.js download page...');
}

function downloadXcode() {
    window.open('https://apps.apple.com/us/app/xcode/id497799835', '_blank');
    showNotification('Opening Xcode on App Store...');
}

function openExtensions() {
    const extensionsInfo = `
To install React Native extensions in VS Code:

1. Open VS Code
2. Press Ctrl+Shift+X (or Cmd+Shift+X on Mac)
3. Search for "React Native Tools"
4. Install the "React Native Tools" extension by Microsoft
...
- Prettier - Code formatter
    ...
    window.open('https://marketplace.visualstudio.com/items?itemName=msjsdiag.vscode-react-native', '_blank');
}
